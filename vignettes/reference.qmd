...
Searches for a compound by InChI across all systems. Stereochemistry is automatically removed for matching.
...
| `search_compound()` | Search for compounds by InChI |
